...
function Goblin(game) {
    ...
    this.animation = new Animation(ASSET_MANAGER.getAsset("./img/sheet2.png"), 94, 128, 33.3, 32, 0.02, 1, true, false);
    
    this.forwardAnimation = new Animation(ASSET_MANAGER.getAsset("./img/sheet2.png"), 94, 128, 33.3, 32, 0.2, 3, true, false);
    this.backwardAnimation = new Animation(ASSET_MANAGER.getAsset("./img/sheet2.png"), 94.5, 224, 33.3, 32, 0.2, 3, true, false);
    this.leftAnimation = new Animation(ASSET_MANAGER.getAsset("./img/sheet2.png"), 94, 160, 33.3, 32, 0.2, 3, true, false);
    this.rightAnimation = new Animation(ASSET_MANAGER.getAsset("./img/sheet2.png"), 94, 192, 33.3, 32, 0.2, 3, true, false);
